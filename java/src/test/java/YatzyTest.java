...
public class YatzyTest {
    ...
    @DisplayName("two_pair : score sum of one pair")
    @ParameterizedTest
    ...
    @DisplayName("three_of_a_kind : score sum of one pair")
    @ParameterizedTest
    ...
    @DisplayName("four_of_a_kind : score sum of one pair")
    @ParameterizedTest
    ...
    @DisplayName("fullHouse : score 18")
    @ParameterizedTest
