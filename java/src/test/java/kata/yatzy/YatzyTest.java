...
class YatzyTest {
    ...
    void when_yatzy_d1_is_negative_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(-1, 1, 1, 1, 1, YatzyTypeEnum.YATZY));
    ...
    @Test
    @DisplayName("Should throw IllegalArgumentException when d1 is negative")
    void when_yatzy_d1_is_greater_than_six_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(7, 1, 1, 1, 1, YatzyTypeEnum.YATZY));
        assertEquals("d1 must be between 1 and 6", illegalArgumentException.getMessage());
    ...
    void when_yatzy_d2_is_negative_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(1, -1, 1, 1, 1, YatzyTypeEnum.YATZY));
    ...
    void when_yatzy_d2_is_greater_than_six_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(1, 7, 1, 1, 1, YatzyTypeEnum.YATZY));
        assertEquals("d2 must be between 1 and 6", illegalArgumentException.getMessage());
    }

    @Test
    @DisplayName("Should throw IllegalArgumentException when d3 is negative")
    void when_yatzy_d3_is_negative_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(1, 1, -1, 1, 1, YatzyTypeEnum.YATZY));
    ...
    void when_yatzy_d3_is_greater_than_six_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(1, 1, 7, 1, 1, YatzyTypeEnum.YATZY));
    ...
    void when_yatzy_d4_is_negative_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(1, 1, 1, -1,1, YatzyTypeEnum.YATZY));
    ...
    void when_yatzy_d4_is_greater_than_six_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(1, 1, 1, 7, 1, YatzyTypeEnum.YATZY));
    ...
    void when_yatzy_d5_is_negative_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(1, 1, 1, 1, -1, YatzyTypeEnum.YATZY));
    ...
    void when_yatzy_d5_is_greater_than_six_should_throw_IllegalArgumentException() {
        var illegalArgumentException = assertThrows(IllegalArgumentException.class,
            () -> Yatzy.score(6, 1, 1, 1, 7, YatzyTypeEnum.YATZY));
    ...
    void chance_scores_sum_of_all_dice(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.CHANCE));
    }

    @DisplayName("kata.yatzy.Yatzy : score 50")
    @ParameterizedTest
    ...
    void yatzy_scores_50(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.YATZY));
    }

    @DisplayName("kata.yatzy.Yatzy : score 0")
    @ParameterizedTest
    ...
    void test_1s_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.ONES));
    }
    ...
    void test_2s_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.TWOS));
    }
    ...
    void test_3s_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.THREES));
    }
    ...
    void test_4s_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.FOURS));
    }
    ...
    void test_5s_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.FIVES));
    }
    ...
    void test_6s_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.SIXES));
    }
    ...
    void test_one_pair_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.PAIR));
    }
    ...
    void test_two_pair_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.TWO_PAIRS));
    }
    ...
    void test_three_of_a_kind_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.THREE_OF_A_KIND));
    }
    ...
    void test_four_of_a_kind_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.FOUR_OF_A_KIND));
    }
    ...
    void test_small_straight_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.SMALL_STRAIGHT));
    }
    ...
    void test_large_straight_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.LARGE_STRAIGHT));
    }
    ...
    void test_full_house_success(int d1, int d2, int d3, int d4, int d5, int expected) {
        assertEquals(expected, Yatzy.score(d1, d2, d3, d4, d5, YatzyTypeEnum.FULL_HOUSE));
    }
